...
namespace ZNxtApp.Core.Module.App.Services.Api.Setting
{
    public class SettingController : ViewBaseService
    {
        public SettingController(ParamContainer paramContainer) : base(paramContainer)
        {
        }
        ...
        public JObject Get()
        {
            try
            {
                return GetPaggedData(CommonConst.Collection.APP_SETTING);
            }
            catch (Exception ex)
            {
