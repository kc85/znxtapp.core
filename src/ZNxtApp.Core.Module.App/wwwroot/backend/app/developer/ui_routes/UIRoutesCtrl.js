    ...
    function ($scope, $location, $rootScope, $controller, dataService, userData) {
        ...
        $scope.active = function () {
            if ($scope.loadingData == false) {
                ...
                dataService.get("./api/admin/common/get?collection=backend_ui_routes&pagesize=" + $scope.pageSize + "&currentpage=" + $scope.currentPage + "&filter=" + $scope.getFilter()).then(function (response) {
