            ...
            sideS.$sideContents.find('li.nav-prev').on('click', function () {
                ...
                if (!rtlDirectionFlag) {
                    TweenMax.to($subMenus, 0.7, {
                        left: '-100%', ease: Power4.easeOut, onComplete: function () {
                    ...
                    TweenMax.to($subMenus, 0.7, {
                        right: '-100%', ease: Power4.easeOut, onComplete: function () {
                            $subMenus.css('display', 'none');
                            sideS.menuFlag = false;
                        }
                    });
        ...
        toggleMenu: function (dir) {
            ...
            if (!rtlDirectionFlag) {
				...
				.to(sideS.$innerBar, timing, {
				    left: 0, ease: Power4.easeOut, onStart: function () {
                ...
                animIn
				.to(sideS.$innerBar, timing, {
				    left: -compactWidth, ease: Power4.easeOut, onStart: function () {
                ...
                animOut
				.to(sideS.$innerBar, timing, {
				    right: 0, ease: Power4.easeOut, onStart: function () {
				        sideS.$menuToggle.removeClass('anim-out');
				        sideS.$sidebar.css('z-index', 0);
				        sideS.$main.css('display', 'block');
				    }, onComplete: function () {
                ...
                animIn
				.to(sideS.$innerBar, timing, {
				    right: -compactWidth, ease: Power4.easeOut, onStart: function () {
				        sideS.$menuToggle.addClass('anim-out');
				        sideS.$sidebar.css('display', 'block');
				    }, onComplete: function () {
				        sideS.$sidebar.css('z-index', 10);
    ...
    var ajaxFolio = {
        ...
        showLoader: function (callback) {
            ...
            TweenMax.to(self.loader, 1, {
                width: '100%', ease: Power2.easeOut, onComplete: function () {
                    if (typeof (callback) == 'function') {
                        callback();
                    }
                }
...
function submitContact() {
    ...
    contactForm.submit(function (e) {
        ...
        hideAlert.to(alertWrapper, 0.3, {
            opacity: 0, top: '60%', onComplete: function () {
                alertWrapper.remove();
            }
        });
