...
nuget  push ZNxtApp.Core.Module.SMS.TextLocal.1.0.1.864-Alpha.nupkg -Source https://api.nuget.org/v3/index.json

del ZNxtApp.Core.Module.SMS.TextLocal.1.0.1.864-Alpha.nupkg