...
nuget  push ZNxtApp.Core.Module.Theme.1.0.11.38791-Beta.nupkg -Source https://api.nuget.org/v3/index.json

del ZNxtApp.Core.Module.Theme.1.0.11.38791-Beta.nupkg