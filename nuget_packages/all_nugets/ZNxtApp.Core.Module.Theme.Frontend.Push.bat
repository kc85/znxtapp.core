...
nuget  push ZNxtApp.Core.Module.Theme.Frontend.1.0.9-Beta.nupkg -Source https://api.nuget.org/v3/index.json

del ZNxtApp.Core.Module.Theme.Frontend.1.0.9-Beta.nupkg